...
public class FullElementList<T> implements ElementList<T>
{
	...
	@Override
	public synchronized T get(long idx) throws IOException, DataFormatException
	{
		return list.get(idx);
	}
	...
	@Override
	public synchronized ListElementIterator<T> iterator(long idx) throws IOException
	{
